...
Prefer scaffolding from the bundled templates or `new_notebook.py` (for example, `$OMNI_SUPERDEV_SKILL/references/bundled/jupyter-notebook/scripts/new_notebook.py`) instead of hand-authoring raw notebook JSON.
